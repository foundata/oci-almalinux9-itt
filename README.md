# OCI Image: AlmaLinux 9, Integration Test Target (ITT)

[AlmaLinux 9](https://wiki.almalinux.org/release-notes/) for integration testing.
...
2. Clone or pull the latest changes from the [`foundata/oci-almalinux9-itt` git repository](https://github.com/foundata/oci-almalinux9-itt).
3. Change into the directory and execute the [build command](https://docs.podman.io/en/latest/markdown/podman-build.1.html):
   ```bash
   podman build -t almalinux9-itt .
   ```
...
2. Use the image you built earlier or pull the image from a registry:
   - [Quay](https://quay.io/repository/foundata/almalinux9-itt):
     ```bash
     podman pull quay.io/foundata/almalinux9-itt:latest
     ```
   - [Docker Hub](https://hub.docker.com/r/foundata/almalinux9-itt):
     ```bash
     podman pull docker.io/foundata/almalinux9-itt:latest
     ```
3. Run a container from the image:
   ```bash
   podman run --detach --systemd=always almalinux9-itt:latest "/usr/sbin/init"
   ```
...
[![REUSE status](https://api.reuse.software/badge/github.com/foundata/oci-almalinux9-itt)](https://api.reuse.software/info/github.com/foundata/oci-almalinux9-itt)
